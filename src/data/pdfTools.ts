...
export const pdfTools: PdfToolMeta[] = [
  ...
  },
  {
    ...
    descriptionKey: 'tools.pdfToWord.desc',
    route: toolPath('pdf-to-word'),
    featureKey: 'pdf_to_word',
    category: 'convert',
    mode: 'cloud',
    access: 'login',
  ...
  },
  {
    ...
    descriptionKey: 'tools.pdfToExcel.desc',
    route: toolPath('pdf-to-excel'),
    featureKey: 'pdf_to_excel',
    category: 'convert',
    mode: 'cloud',
    access: 'login',
    smokeTag: 'access-panel',
    component: () => import('@/views/tools/PDFToExcel.vue'),
    icon: Sheet,
    accent: 'emerald',
  },
  {
  ...
  },
  {
    id: 'htmlToPdf',
    slug: 'html-to-pdf',
    routeName: 'html-to-pdf',
    titleKey: 'tools.htmlToPdf.title',
    descriptionKey: 'tools.htmlToPdf.desc',
    route: toolPath('html-to-pdf'),
    featureKey: 'html_to_pdf',
    category: 'convert',
    mode: 'cloud',
    access: 'login',
    smokeTag: 'access-panel',
    component: () => import('@/views/tools/HTMLToPDF.vue'),
    icon: FileText,
    accent: 'sky',
  },
  {
    ...
    titleKey: 'tools.batchConvert.title',
    descriptionKey: 'tools.batchConvert.desc',
    route: toolPath('batch-convert'),
    featureKey: 'batch_convert',
    category: 'convert',
    mode: 'cloud',
    access: 'login',
    smokeTag: 'access-panel',
    component: () => import('@/views/tools/BatchConvert.vue'),
    icon: Boxes,
    accent: 'slate',
  },
  {
  ...
  },
  {
    ...
    descriptionKey: 'tools.fillForm.desc',
  ...
  },
  {
    ...
    descriptionKey: 'tools.annotate.desc',
